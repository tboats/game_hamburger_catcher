...
| Key | Text |
|---|---|
| `report_title` | Báo cáo quét bảo mật mã nguồn |
...
| Key | Text |
|---|---|
| `footer_generated_by` | Báo cáo dựa trên tham khảo các điểm bảo mật theo |
| `footer_repo` | https://owasp.org/www-project-top-ten/ |
...
| `msg_gitignore_warning_text` | Thư mục `reports/security/` chưa có trong `.gitignore`. Để tránh commit báo cáo vào Git, thêm dòng `reports/security/` vào `.gitignore`. |
| `msg_reports_dir_created` | Đã tạo thư mục `reports/security/` để lưu báo cáo |
